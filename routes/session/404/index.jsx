							...
							<div className="container">
								<div className="d-flex justify-content-between">
									<div className="session-logo">
										<Link to="/">
											<img src={require('Assets/img/logo-sts.png')} alt="session-logo"
											     className="img-fluid" width="110" height="35"/>
										</Link>
									</div>
						...
						<div className="row">
							<div className="col-sm-12 col-md-12 col-lg-9 mx-auto">
								<div className="error-body text-center">
									...
									<h4 className="mb-50">Looks like you have navigated too far from Federation Space.
										Our Application <br />
										cannot help you here.</h4>
									<Button component={Link} to="/" variant="raised" className="btn-light btn-lg">Go To
										Home Page</Button>
								</div>
							</div>
						</div>
